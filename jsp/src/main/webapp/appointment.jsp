...
<div class="w3-top">
  ...
  <%@ page import = "Model.*" %>
    <form action="SEND ADDRESS" id="ft-form" method="POST" accept-charset="UTF-8" method ="get">
        <fieldset>
        ...
        <form action="/action_page.php">
          <label for="cars">Choose the service:</label>
          <select name="cars" id="cars">
              <option value="volvo">Gym</option>
              <option value="saab">Spa</option>
              <option value="mercedes">Saloon</option>
              <option value="audi">Private Pool</option>
          </select>
          <br><br>
          <input type="submit" value="Submit">
        </form>
         <formaction="SEND ADDRESS" id="ft-form" method="POST" accept-charset="UTF-8">
        <fieldset>
          ...
          <div class="two-cols">
            ...
            <div class="inline">
              <label>
                ...
                <input type="radio" name="Morning desired" value="yes">
                Morning
              </label>
              <label>
                <input type="hidden" name="Afternoon desired" value="no">
                <input type="radio" name="Afternoon desired" value="yes">
                Afternoon
              </label>
            </div>
          </div>
        ...
        <div class="btns">
          ...
          <input type="submit" value="Submit request" onclick = "return createNew()"/>
        </div>
      </form>
</body>